...
const PLATFORMS = {
    ...
    threads: {
        ...
        icon: (props) => (
            <svg {...props} viewBox="0 0 24 24" fill="currentColor" className="text-current">
                <path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.512C2.038 19.107 1.153 15.904 1.654 12.31c.282-1.703 1.165-3.28 2.498-4.495 1.386-1.262 3.155-1.963 5.237-2.09V4.25c0-.675.54-1.325 1.46-1.325.92 0 1.46.65 1.46 1.325v1.41c.542.016 1.048.053 1.543.115.786.1 1.414.703 1.518 1.488.127.95-.486 1.768-1.446 1.917-1.36.21-2.82.273-4.373-.003-1.09-.18-2.14.255-2.78 1.103-.66.876-.632 1.953.068 2.765.69.793 1.573 1.127 2.673 1.03 2.92-.276 4.837-.603 6.48-1.1 2.656-.815 4.118-2.297 4.598-4.747.158-.816.1-1.643-.133-2.36-.566-1.698-2.036-2.7-4.312-3.02-2.283-.32-4.563-.333-6.903.036-1.52.232-2.316-.893-2.143-2.173.22-1.584 1.697-2.32 3.246-2.573 2-.313 3.97-.266 5.943-.007 3.913.493 7.03 2.25 8.443 4.987.734 1.5.85 3.143.33 4.946-.727 2.47-2.303 3.923-4.963 4.837-1.69.587-3.71 1.003-6.073 1.272-1.24.135-2.266-.64-2.44-1.848-.057-.387-.04-.786.05-1.177.21-1.14 1.08-1.76 2.053-1.753 1.013.007 1.647.68 1.647 1.777 0 1.413 1.266 2.373 2.66 1.913 1.4-.462 2.167-1.93 2.167-4.04 0-1.957-.847-3.31-2.637-4.207-1.667-.845-3.463-1.223-5.553-.907-1.317.197-2.04 1.083-2.026 2.38.006.55.178 1.037.497 1.453.587.75 1.44 1.122 2.59 1.175.72.033 1.434-.077 2.136-.307.84-.28 1.353-.107 1.667.373.33.503.267 1.1-.15 1.623-.777 1.007-2.05 1.37-3.547 1.013z" />
            </svg>
        ),
        color: '#ffffff',
        bgClass: 'bg-[#000000]',
